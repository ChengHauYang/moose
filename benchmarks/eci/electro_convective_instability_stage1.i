...
# fully developed. Stage 2 restarts from the checkpoint, adds a velocity seed,
# and turns on the coupled Navier-Stokes transport.
...
[Mesh]
  ...
  [assembly]
    ...
    inputs = 'bottom_stripe top_stripe'
