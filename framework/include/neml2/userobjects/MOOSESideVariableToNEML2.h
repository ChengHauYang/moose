 ...
 *
 * This class is basically the same as MOOSEVariableToNEML2Templ, but inherits from
 * MOOSEToNEML2SideBatched instead of MOOSEToNEML2Batched, and thus gathers data on sidesets instead
 * of elements.
 */
