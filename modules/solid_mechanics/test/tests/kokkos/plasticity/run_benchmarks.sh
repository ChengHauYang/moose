...
CPU_PETSC_OPTIONS="-vec_type standard -mat_type aij -use_gpu_aware_mpi 0 -snes_converged_reason -ksp_converged_reason -ksp_view"
GPU_PETSC_OPTIONS="-vec_type kokkos -mat_type aijkokkos -use_gpu_aware_mpi 0 -snes_converged_reason -ksp_converged_reason -ksp_view"
...
run_step()
{
  ...
  local petsc_options=$CPU_PETSC_OPTIONS
  local device_args=()
