...
<<<<<<<< HEAD:modules/subchannel/test/tests/problems/psbt/psbt_explicit_staggered.i
========
  implicit = true
  segregated = false
  monolithic_thermal = true
>>>>>>>> subdomain_modifier_dev:modules/subchannel/test/tests/problems/psbt/psbt_full_monolithic_staggered.i
